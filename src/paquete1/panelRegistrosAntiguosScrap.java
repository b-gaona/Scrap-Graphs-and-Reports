...
public class panelRegistrosAntiguosScrap extends javax.swing.JPanel {

    PreparedStatement ps;
    ResultSet rs;

    public panelRegistrosAntiguosScrap() {
        initComponents();
        FA fa = new FA();
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 230, 390, 130));
        ...
        etiquetaOpcion.setText("Seleccione una opcion: ");
        ...
        add(etiquetaFechaInicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 360, -1, -1));
        ...
        add(seleccionarFechaRegistro, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 390, 220, 40));
        ...
        add(etiquetaHoraInicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 360, -1, -1));

        seleccionarHoraRegistro.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        seleccionarHoraRegistro.setVisible(false);
        add(seleccionarHoraRegistro, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 390, 100, 40));
        ...
        add(botonHoraInicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 390, 40, 40));
